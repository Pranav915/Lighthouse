...
<hr style={{'height':'8px','marginLeft':'50px','background':'linear-gradient(-135deg, #71b7e6, #9b59b6)'}} />
    ...
    <div class="d-flex flex-column align-items-center text-center p-3 py-5" style={{'width':'50%','marginLeft':'0px','paddingLeft':'120px'}}>
        <img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"/><span> </span>
    ...
    <div className="content">
      <form action="#">
        <div className="user-details">
          ...
          <div className="input-box">
            <label for="category" style={{'fontWeight':'500'}}>Category</label>
            <select name="category" id="category" className="details" style={{'marginTop':'5px','width':'300px','height':'45px','borderRadius':'5px','borderWidth':'2px','borderColor':'#9b59b6'}}>
