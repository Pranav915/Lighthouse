      ...
      <form action="#">
        <div className="user-details">
          ...
          <div className="input-box">
            ...
            <select name="category" id="category" value={category} className="details" style={{'marginTop':'5px','width':'300px','height':'45px','borderRadius':'5px','borderWidth':'2px','borderColor':'#9b59b6'}}>
