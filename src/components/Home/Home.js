      ...
      <div className="container">
        <nav className="navbar site-navbar">
          <div className="brand-logo">
            <a href="#">
              <img src="image/logo/logo-black.png" alt="" className="light-version-logo"/>
              <img src="image/logo/logo-white.png" alt="" className="dark-version-logo"/>
            </a>
          </div>
            ...
            <nav className="menu-block" id="append-menu-header">
              ...
              <ul className="site-menu-main">
                <li className="nav-item nav-item-has-children">
                  <a href="#" className="nav-link-item drop-trigger">Dropdowns <i className="fas fa-angle-down"></i>
                  </a>
                ...
                <li className="nav-item">
                  <a href="https://uxtheme.net/product-support/" className="nav-link-item">Support</a>
                </li>
              </ul>
            </nav>
          </div>
          <div className="header-btns  header-btn-l11 ms-auto d-none d-xs-inline-flex align-items-center">
            {/* <a className="btn log-in-btn focus-reset" href="#">
              Log in
            </a> */}
            <a className="download-trail-btn btn focus-reset" href="#">
              Log In
            </a>
          </div>
        ...
        <div className="row position-relative justify-content-center">
          <div className="col-xl-8 col-lg-9 col-md-12 order-lg-1 order-1" data-aos="fade-up" data-aos-duration="500" data-aos-once="true">
            <div className="content">
              <h1>Landing page<br className="d-none d-md-block"/> built for software.</h1>
                ...
                <div className="col-xl-3 col-lg-4">
                  <div className="compitable-text border-top d-inline-block">
                    ...
                    <div className="compatible-icon flex-y-center img-grayscale">
                      <a href="#" className="font-size-13 mr-7"><img src="./image/l2/windows.svg" alt=""/></a>
                      <a href="#" className="font-size-13 mr-7"><img src="./image/l2/apple.svg" alt=""/></a>
                      <a href="#" className="font-size-13"><img src="./image/l2/penguine.svg" alt=""/></a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-lg-9 order-lg-1 order-0" data-aos="fade-up" data-aos-duration="800" data-aos-once="true">
            <img src="image/l2/laptop-screen.png" alt="" className="w-100 hero-l11-main-image"/>
          </div>
        </div>
      </div>
        ...
        <div className="row align-items-center justify-content-lg-start justify-content-center">
          <div className="col-xl-6 col-md-5 col-md-10" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
            <div className="content-img position-relative z-index-1">
              <img src="image/l2/content-img1.png" alt="" className="w-100"/>
            </div>
          </div>
        ...
        <div className="row align-items-center justify-content-lg-between justify-content-center">
          ...
          <div className="col-xxl-6 offset-xxl-2 col-xl-6 col-lg-5 col-md-9 order-lg-1 order-0" data-aos="fade-left" data-aos-duration="800" data-aos-once="true">
            <div className="content-img">
              <img src="image/l2/content-img2.png" alt="" className="w-lg-auto w-100"/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row align-items-center justify-content-center justify-content-lg-start">
          <div className="col-xl-6 col-lg-6 col-md-8 order-lg-1 order-0" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
            <div className="content-img">
              <img src="image/l2/content-img3.png" alt="" className="w-100"/>
            </div>
          </div>
            ...
            <div className="content section-heading-5">
              ...
              <ul className="list-unstyled pl-0">
                <li className="d-flex align-items-center">
                  <i className="fas fa-check"></i>Unlimited design possibility
                </li>
                <li className="d-flex align-items-center">
          ...
          <div className="col-xxl-6 col-xl-7 col-lg-8 col-md-11" data-aos="fade-up" data-aos-duration="800" data-aos-once="true">
            <div className="content text-center">
              ...
              <div className="btn-area">
                <a href="#" className="btn"><i className="fas fa-download d-inline-block"></i> Download Free Trial</a>
              </div>
          ...
          <div className="col-md-6">
            <div className="footer-widget-l-11">
              <ul className="pl-0 list-unstyled d-flex flex-wrap justify-content-center align-items-end ">
                <li className="d-flex"><a href="">About</a></li>
                <li className="d-flex"><a href="">Features</a></li>
                <li className="d-flex"><a href="">Works</a></li>
                <li className="d-flex"><a href="">Career</a></li>
                <li className="d-flex"><a href="">Contact</a></li>
              </ul>
            </div>
          </div>
          <div className="col-md-3">
            <div className="social-icons-l-11">
              <ul className="pl-0 list-unstyled d-flex  justify-content-center justify-content-md-end align-items-end ">
                <li className="d-flex flex-column justify-content-center"><a href="#"><i
